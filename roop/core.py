...
def parse_args() -> None:
    ...
    program.add_argument('--keep-fps', help='keep target fps', dest='keep_fps', default=True, action='store_true')
    ...
    program.add_argument('--max-memory', help='maximum amount of RAM in GB', default=16, dest='max_memory', type=int)
